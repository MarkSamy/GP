...
//ACCESSORS
	...
	public String getMemberRole(String string) {
		...
		while(!found && index < members.size()) {
			String temp = members.get(index).type + " " + members.get(index).ref;
		...
		if(!found) {
			throw new RuntimeException("Element "+string+" not found");
		}
...
//INNER CLASS Member
	...
	//CONSTRUCTOR
		 ...
		 */
		private Member(String newRole, String newType, String newRef) {
