...
//	private Map<String,Element> elements;
	...
	StringBuilder csvNodesBuild;
	StringBuilder csvWaysBuild;
	StringBuilder csvRelsBuild;
	
	ArrayList<String> nodes;
	ArrayList<String> ways;
	ArrayList<String> relations;
	
	File nodesFile, waysFile, relsFile;
	File nodesFile_Two;
	PrintWriter nodesWriter_Two;
	File dataFile;
	PrintWriter dataWriter;
	
	PrintWriter nodesWriter,waysWriter, relsWriter;
	
	int nbNodes = 0, nbWays = 0, nbRels = 0, elements = 0;
...
//OTHER METHODS
	...
	public Object parse(InputSource input) throws SAXException, IOException {
	    ...
	    System.out.println(nbNodes +" " + nbWays + " " + nbRels);
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if(localName.equals("node") || localName.equals("way") || localName.equals("relation")) {
			...
			if(current != null) {
				...
				|| (localName.equals("way") && ((Way) current).getNodes().size() >= 2)
...
//				        	nodesWriter_Two.print(current.getId() + ";" + currentNode.getLat()  + ";" + currentNode.getLon()+ "\n");
//					        
...
//						}
//						csvRelsBuild.append("]\";");
//						relations.add(currentRel.getId());
